let
  self = {
    local = {
      boxA = let drive = self.local.boxA.drives.primary; in {
        ...
        modules = {
          ...
          wireguard =
            ...
            in
            {
              ...
              tcpPorts = [ 8080 8082 8083 8084 i2pPort ];
              udpPorts = [ i2pPort ];
            };
          ...
          nginx = {
            ...
            hosts = gen: gen.upstream self.local.boxA.dns."boxA.local.wg" {
